...
Load London Wards
```{r}
LondonWards <- readOGR("/Volumes/ucfnnap/CASA_GIS and Sc/wk6/LondonWardData/LondonWards.shp", layer="LondonWards")
```
...
LondonWards@data$BlueDensity <- LondonWards$BluePlaqueCount*100000/poly.areas(LondonWards)
...
We have used sp objects in this practical (because I wrote it before sf became the defacto spatial data type in R). Can you convert some of this so it works withsf?  
Could you atomate any of the functions so that you could quickly produce maps of any of the variables in the LondonWards dataset?  
Could you get these outputs into a faceted ggplot2 map?  
